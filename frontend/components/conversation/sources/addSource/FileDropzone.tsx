...
const FileDropzone = ({ onFile }: FileDropzoneProps) => {
    ...
    return (
        <div onDragEnter={handleDragEnter} onDragLeave={handleDragLeave} onDragOver={handleDragOver} onDrop={handleDrop} className={cn('flex min-h-52 flex-col rounded-2xl border border-dashed p-5 transition-colors', isDragging ? 'border-sky-500 bg-sky-500/10' : 'border-muted-foreground/35')}>
