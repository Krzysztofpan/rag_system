...
async def test_apply_document_summary_stores_catalog_and_updates_metadata():
    ...
    with (
        ...
        patch(
            "app.services.conversation.documents_catalog.get_session_factory",
            return_value=session_factory,
        ),
        patch(
            "app.services.conversation.documents_catalog.create_conversation_service",
            return_value=conversation_service,
        ),
        patch(
            "app.services.conversation.documents_catalog.create_conversation_memory_service",
            return_value=memory_service,
        ),
        patch(
            "app.services.conversation.documents_catalog.create_document_service",
        ...
        patch(
            "app.services.conversation.documents_catalog.ConversationDocumentsSummarizer.synthesize",
...
async def test_refresh_and_publish_documents_summary_skips_title_update():
    ...
    with (
        ...
        patch(
            "app.services.conversation.documents_catalog.get_conversation_event_broker",
            return_value=broker,
        ),
        patch(
            "app.services.conversation.documents_catalog.ConversationDocumentsSummarizer.synthesize",
